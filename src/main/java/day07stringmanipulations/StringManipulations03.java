...
public class StringManipulations03 {
    ...
    public static void main(String[] args) {
        ...
        char last =name.trim().toUpperCase().split(" ")[1].charAt(0); // icine yazdigin seyi silip 2 ye boler [0] ve [1] oalrak ikiye ayrilir
        System.out.println(last);

        System.out.println(first + last); // charlari toplarsan sayi gibi davranir o yuzden basina "" koyacaz
